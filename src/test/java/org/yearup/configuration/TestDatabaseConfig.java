...
@Configuration
//Add @PropertySource to the Configuration Class: Explicitly tell Spring where to find the properties file:
...
//            runner.runScript(new InputStreamReader(new ClassPathResource("test-data.sql").getInputStream()));
//            conn.commit();
//        }
